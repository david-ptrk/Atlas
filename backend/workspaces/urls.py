...
from .views import WorkspaceListView, WorkspaceDetailView, WorkspaceJoinView, WorkspaceDocumentView, WorkspaceLeaveView
...
urlpatterns = [
    ...
    path('<int:pk>/leave/', WorkspaceLeaveView.as_view(), name='workspace-leave'),
